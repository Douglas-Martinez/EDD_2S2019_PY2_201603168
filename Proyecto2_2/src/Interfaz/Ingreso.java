...
public class Ingreso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(us == null) {
            JOptionPane.showMessageDialog(this,"El Usuario no existe","Usuario Inexistente",JOptionPane.ERROR_MESSAGE);
            jTextField1.setText("");
            ...
            if(us.usuario.equals("Admin")) {
                ...
                if(pass.length() < 8) {
                    JOptionPane.showMessageDialog(this,"La contraseña debe de sera de al menos 8 caracteres","Contraseña Incorrecta",JOptionPane.WARNING_MESSAGE);
                    jPasswordField1.setText("");
                } else {
                    if(us.password.equals(pass)) {
                        Proyecto2_2.actual = us;
                        ...
                        this.dispose();
                        try {
                            Parent root = FXMLLoader.load(getClass().getResource("descarga/Scene.fxml"));
                            //Descarga.scene.setScene(new Scene(root));
